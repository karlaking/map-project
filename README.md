...
1. Users who did not create the item should not be able to edit the item's data
...
1. Users who did not create the item should not be able to delete the item
